package br.com.delos.utils.webservices;
...
/* M�todos e variaveis estaticas, respons�veis pela busca do CEP */
    /**
     * Mascara para a string url de conexão, onde <tt>"%s"</tt> substituido pelo valor
     * do cep. 
     */
     ...
     * @throws DocumentException Quando h� problema na formação do documento XML.
	 ...
	 * {@link WebServiceCep}.
	 * <BR>
	 * <BRNão se faz necessário formatações, a string pode ser enviada em qualquer
	 * formatação, pois s� serão consideradas os primeiros 8 numeros da string.
	 * <BR>Por Exemplo:
	 ...
	 * @param	cep Número do cep a ser carregado. Serão os primeiros 8
...
/* PUBLIC m�todos get e is, usado para acessar o objeto ap�s carregado. */
	 ...
	 * <BR><tt>-15</tt> : Não foi possível ler o documenot xml
	 * <BR><tt>-16</tt> : Erro na formação da url
	 * <BR><tt>-17</tt> : Erro inesperado
	 * 
	 * 
	 * @return <tt>int</tt> Código resultado
	 */
